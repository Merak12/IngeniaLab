  ...
  <body>
    ...
    <form action="/IngeniaLab/src/login/login_process.php" method="POST">
      ...
      <table align="center">
        ...
        <tr>
          <td align="center">
            <button type="submit" style="padding: 10px 20px; font-size: 16px"> Log in </button>
            <button type="button" onclick="location.href='/IngeniaLab/src/views/register.php'" style="padding: 10px 20px; font-size: 16px"> Register </button>
          </td>
        </tr>
