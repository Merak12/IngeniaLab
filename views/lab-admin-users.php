...
<nav class="navbar">
    ...
    <div class="heading-admin">
        <div display="inline-block" style="width: 30%;"><h1>Usuarios</h1></div>
    </div>
    ...
    <table class="equipment-table">
        ...
        <tbody>
            ...
            $sql = 'SELECT id, nombre, correo FROM mdp_v1_usuarios';
    ...
    <script>
        ...
        function deleteUser(id) {
            window.location.href = '/IngeniaLab/src/php/deleteUser.php?id=' + id;
        }
